...
var file_nameservice_proto_depIdxs = []int32{
	...
	4, // 1: qeco.apis.kns.v1.ResolveResponse.ttl:type_name -> google.protobuf.Duration
	0, // 2: qeco.apis.kns.v1.NameService.Register:input_type -> qeco.apis.kns.v1.RegisterRequest
	2, // 3: qeco.apis.kns.v1.NameService.Resolve:input_type -> qeco.apis.kns.v1.ResolveRequest
	1, // 4: qeco.apis.kns.v1.NameService.Register:output_type -> qeco.apis.kns.v1.RegisterResponse
	3, // 5: qeco.apis.kns.v1.NameService.Resolve:output_type -> qeco.apis.kns.v1.ResolveResponse
